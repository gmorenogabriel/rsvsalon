...
// Ahora agrega el evento para 'eventClick'
calendar.on('eventClick', function(info) {
    alert(`Evento: ${info.event.title}\nCédula: ${info.event.extendedProps.cedula}\nNombre: ${info.event.extendedProps.nombre}\nCelular: ${info.event.extendedProps.celular}`);
});
// ------------------------------------------------------------------------------------------
document.getElementById("eventForm").addEventListener("submit", function(e) {
    ...
    if (start) {
        ...
        if (horas >= 11 && horas <= 18) {
            ...
            console.log('Matutino Fecha inicio: ', inicio);
            ...
            // Formatear la nueva fecha y hora
            fecha = new Date(start);
            // Establecer la hora de inicio a las 19:00
            fecha.setHours(19, 0, 0, 0);
            let inicioN = new Date(fecha);
            inicio = convertirFecha(inicioN);
            console.log('Nocturno Fecha inicio: ', inicio);

            // Establecer la hora de fin a las 23:59
    ...
    .then(data => {
        ...
        if (data.trim() === "ok") {
            ...
            // Opcional: Mostrar cédula, nombre y celular en el evento
            ...
            console.log('Respuesta recibida desde guardar_evento.php: ', data);
